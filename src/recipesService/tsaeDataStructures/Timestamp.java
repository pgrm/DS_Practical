...
public class Timestamp implements Serializable {
    ...
    /**
     * This class represents the timestamp of an operation. Contains the node
     * that issued the operation, and the sequence number of the operation,
     * relative to other operations issued by that node.
     */
     ...
     * number. This will result in a positive number if this is newer than t, a
     * negative number if this is older than t, and 0 if this and t are equal.
     */
