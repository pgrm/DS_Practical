...
//			boolean removeOperationActivated = ("On").equals(properties.getProperty("remove"));
			...
			// create params list
			//
			params.add(properties.getProperty("serverBasePort"));
			params.add(groupId);

			params.add(properties.getProperty("sessionDelay"));
			params.add(properties.getProperty("sessionPeriod"));

			params.add(properties.getProperty("numSes"));
			params.add(properties.getProperty("propDegree"));
			//
