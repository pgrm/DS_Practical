    ...
    public void startSimulation(ServerData serverData) {
        ...
        javax.swing.Timer timerSimulationStop = new javax.swing.Timer(simulationStop, new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (connected) {
                    System.out.println("Server " + SimulationData.getInstance().serverData.getId() + " finishes Activity Simulation");
                } else {
                    System.out.println("Server " + SimulationData.getInstance().serverData.getId() + " finishes Activity Simulation. It will stop because is not connected");
                    System.exit(1);
                }
                ...
                javax.swing.Timer timerExecutionStop = new javax.swing.Timer(executionStop, new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        System.out.println("Server " + SimulationData.getInstance().serverData.getId() + " Ends Execution");
